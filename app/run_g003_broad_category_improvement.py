...
RESULTS_DIR = ROOT_DIR / "results" / "g003_broad_category_improvement"
RUN_DIR = APP_DIR / "output" / "g003_broad_category_improvement"

TARGET_CATEGORIES = ["cosmetics", "food_contact_substances"]
VARIANTS: dict[str, dict[str, Any]] = {
    ...
    "cosmetics_pesticide_negatives": {
        "targets": {"cosmetics"},
        "train_regime": "pesticides_native_source",
        "category_prior": None,
    },
    "cosmetics_pesticide_negatives_category_prior": {
        "targets": {"cosmetics"},
        "train_regime": "pesticides_native_source",
        "category_prior": "auto",
    },
    ...
    "food_contact_related_hard": {
        "targets": {"food_contact_substances"},
        "train_regime": "related_hard",
        "category_prior": None,
    },
    "food_contact_related_hard_category_prior": {
        "targets": {"food_contact_substances"},
        "train_regime": "related_hard",
        "category_prior": "auto",
    },
...
def build_candidate_model(
    *,
    ...
    build_choi_model(
        ...
        model_id=f"g003_{slug}_{variant}_{seed}",
        label=f"G003 {slug} {variant} seed {seed}",
        category=slug,
...
def training_negatives_for_variant(
    *,
    ...
    if train_regime == "pesticides_native_source":
        return sample_list(categories["pesticides"], max_negative, seed + 3100)
    ...
    if train_regime not in regimes:
        raise ValueError(f"Unsupported G003 train regime {train_regime!r} for {variant!r}.")
                ...
                per_run_rows.append(
                    {
                        ...
                        "prior_motifs": ";".join((config.get("category_prior") or {}).get("motifs", {}).keys()),
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run bounded G003 broad-category prior improvement attempts.")
    ...
    write_csv(
        RESULTS_DIR / "g003_broad_category_improvement_per_run.csv",
        payload["per_run"],
        [
            "category",
            "variant",
    ...
    write_csv(
        RESULTS_DIR / "g003_broad_category_improvement_summary.csv",
        payload["summary"],
        [
            "category",
            "variant",
    ...
    write_csv(
        RESULTS_DIR / "g003_broad_category_improvement_audit.csv",
        payload["audit"],
        [
            "category",
            "seed",
    ...
    (RESULTS_DIR / "g003_broad_category_improvement.json").write_text(
